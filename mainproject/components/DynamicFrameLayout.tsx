...
export default function DynamicFrameLayout() {
  ...
  const [showFrames] = useState(false) // fixed off per request
  const [autoplayMode] = useState<"all" | "hover">("all") // fixed to autoplay all
  ...
  return (
    <div className="space-y-4 w-full h-full">
      {/* Controls removed per request (no Show Frames / Autoplay UI) */}
      {!cleanInterface && (
